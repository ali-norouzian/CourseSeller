...
{
    public partial class Mig_AddUserAndRole : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveCode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ActiveCodeGenerateDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
